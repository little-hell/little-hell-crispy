...
static boolean (*ExpandSoundData)(
    sfxinfo_t *sfxinfo, byte *data, int samplerate, int bits, int length) = NULL;
...
static boolean
ExpandSoundData_SRC(sfxinfo_t *sfxinfo, byte *data, int samplerate, int bits, int length)
{
    SRC_DATA src_data;
    float *data_in;
...
static boolean
ExpandSoundData_SDL(sfxinfo_t *sfxinfo, byte *data, int samplerate, int bits, int length)
{
...
static boolean CacheSFX(sfxinfo_t *sfxinfo)
{
...
#ifdef DEBUG_DUMP_WAVS
    {
        ...
        M_snprintf(filename, sizeof(filename), "%s.wav", sfxinfo->name);
