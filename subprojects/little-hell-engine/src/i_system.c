...
byte *I_ZoneBase(int *size)
{
    ...
    printf(
        "zone memory: %p, %d MiB allocated for zone\n",
        zonemem,
...
void I_PrintStartupBanner(const char *gamedescription)
{
    ...
    printf(" This is free software, covered by the GNU General Public\n"
...
void I_Error(const char *error, ...)
{
    ...
    {
        SDL_ShowSimpleMessageBox(SDL_MESSAGEBOX_ERROR, "todo: change me", msgbuf, NULL);
    }
